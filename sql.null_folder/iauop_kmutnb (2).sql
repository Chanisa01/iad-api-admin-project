...
--
-- Host: localhost
-- Generation Time: Jun 06, 2025 at 09:16 AM
...
(2, 'กลุ่มงานตรวจสอบภายใน', 4),
(3, 'กลุ่มงานบริหารและพัฒนาคุณภาพ', 2),
(8, 'ผู้อำนวยการ', 1);
...
(57, '1729900557095', 'ฌานิศา', 'อิ่มลิ้มทาน', 'Chanisa', 'Aimlimthan', '', 'chanisaa', 1, '2025-06-06 08:12:06', '2025-02-05 06:55:49', '', 1, NULL, NULL, '2025-05-05 01:15:42', 57),
...
--
ALTER TABLE `personal`
  MODIFY `id_personal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=203;
